...
A mobile workout tracking app built as a Progressive Web App (PWA), accessible via Safari on iPhone.

**Live app:** https://adakin97.github.io/gym-tracker
...
- **This week**: sessions done out of 4, streak, days since last session, sets per muscle vs the plan
...
## Training Schedule (from 26 Sep 2026)
...
1. Open https://adakin97.github.io/gym-tracker in Safari
2. Tap **Share** → **Add to Home Screen** for a full-screen app experience
3. Log each set by entering weight and reps, then tapping ✓
